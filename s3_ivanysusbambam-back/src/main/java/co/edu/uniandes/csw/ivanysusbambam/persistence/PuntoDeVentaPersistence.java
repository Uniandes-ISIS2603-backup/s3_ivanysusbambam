...
public class PuntoDeVentaPersistence {
    ...
    /**
     * @return devuelve toda la lista de entidades puntoDeVenta en la base de
     * datos
     */
    ...
    /**
     * Busca los puntos de venta con el nombre dado por parametro
     *
     * @param name nombre de los punto de venta a buscar
