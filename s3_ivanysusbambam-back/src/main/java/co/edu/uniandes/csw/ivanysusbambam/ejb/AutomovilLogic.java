...
if(AE == null) throw new BusinessLogicException("El Automovil no debe ser null");
        if(AE.getId() == null || AE.getPuntoDeVenta()== null || AE.getMarca()== null || AE.getModel()== null) throw new BusinessLogicException("Ninguno de los atributos delautomovil puede ser null"); 
    ...
    public void deleteAutomovil(AutomovilEntity entity) throws BusinessLogicException {
       ...
       ("el automovil no puede ser nulo");}
    ...
    public AutomovilEntity findAutomovil(Long id) throws BusinessLogicException {
     if (id == null || id <= 0) throw new BusinessLogicException ("id no valido");
        return persistence.find(id);
    }
