...
public class ClienteLogic {
     ...
     * @throws BusinessLogicException Si la cédula del cliente no está en un formáto válido, ya hay un cliente registrado con esa cédula o si el  nombre no es una cadena alfabética. 
     */
     ...
     * @return una lista con todos los clientes registrados en la base de datos, null si no hay ninguno.
     */
     ...
     * @throws BusinessLogicException si el cliente que se busca eliminar no existe o si el id dado por parámetro == null.
     */
     ...
     * @throws BusinessLogicException si id == null o id no está en un formato válido.
     */
