...
public class MedioDePagoPersistence {
     ...
     */
      ...
      /**
       * 
       * @param numero El numero del objeto que se quiere encontrar en la base de datos
       * @return El medio de pago con el numero que entra por parametro
       */
       public MedioDePagoEntity find(int numero) {
    ...
    */
     ...
     */
    public void delete(MedioDePagoEntity entity) {
        em.remove(entity);
    }
}
