...
public class ProspectoCompraPersistence {
    ...
    /**
     * Encuentra una serie de ProspectoCompraEntity según el vendedor que los
     * creó.
     *
     * @param ve VendedorEntity al que pertenece ProspectoCompraEntity
     * @return lista con los ProspectoCompraEntity pertenecientes al
     * VendedorEntity dado por parámetro.
     */
    ...
    /**
     * Encuentra una serie de ProspectoCompraEntity pertenecientes a un cliente
     * dado por parámetro.
     *
     * @param ce ClienteEntity a quien pertenecen los ProspectoCompraEntity
     * buscados.
     * @return Lista con los ProspectoCompraEntity pertenecientes al
     * ClienteEntity dado por parámetro.
     */
