...
public class PuntoDeVentaResource {
    ...
    /**
     * Atributo de la logica del punto de venta
     */
    @Inject
    private PuntoDeVentaLogic puntoDeVentaLogic;

    /**
     * GET api/puntosDeVenta Retorna todos los puntos de venta.
     *
     ...
     * </pre>
     *
     * @param id Identificador del punto de venta que se esta buscando. Este
    ...
    /**
     * <h1>PUT /api/puntosDeVenta/{id} : Actualizar punto de venta con el id
     * dado.</h1>
     ...
     * </pre>
     *
     * @param id Identificador del punto de venta que se desea actualizar. Este
     * debe ser una cadena de dígitos.
     * @param pv {@link PuntoDeVentaDetailDTO} El punto de venta que se desea
     * guardar.
     * @return JSON {@link PuntoDeVentaDTO} - El punto de venta guardado.
     * @throws WebApplicationException {@link WebApplicationExceptionMapper} -
     * Error de lógica que se genera cuando no se encuentra el punto de venta a
     * actualizar.
     */
    @PUT
     ...
     * </pre>
     *
     * @param id Identificador del punto de venta que se desea borrar. Este debe
     ...
     * @param pv{@link PuntoDeVentaDetailDTO} - EL punto de venta que se desea
     * guardar.
     * @return JSON {@link PuntoDeVentaDetailDTO} - El punto de venta guardado
