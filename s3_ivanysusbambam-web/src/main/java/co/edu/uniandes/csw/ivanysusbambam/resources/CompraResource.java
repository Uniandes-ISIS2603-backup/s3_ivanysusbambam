...
public class CompraResource {
     ...
     * </pre>
     * @return JSONArray {@link CompraDetailDTO} - Las ciudades encontradas en la aplicación. Si no hay ninguna retorna una lista vacía.
     */
    @GET
    ...
    @PUT
    @Path("{idCompra: \\d+}")
    public CompraDetailDTO updateCompra(@PathParam("idCompra") String idCompra, CompraDetailDTO compra) throws BusinessLogicException {
        return compra;
    }
    /**
    ...
    @DELETE
    @Path("{idCompra: \\d+}")
     public void deleteCompra(@PathParam("idCompra") String id) {
        // Void
    }
}
