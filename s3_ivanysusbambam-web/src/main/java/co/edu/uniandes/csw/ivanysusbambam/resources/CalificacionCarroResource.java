...
public class CalificacionCarroResource {
    ...
    /**
     * Atributo para la logica de calificacionCarro
     */
    @Inject
    ...
    /**
     * <h1>GET /api/calificacionesCarro/{id} : Obtener calificacion de un carro
     * por id.</h1>
     *
     ...
     * </pre>
     *
     * @param id Identificador de la calificacion de un carro que se esta
     * buscando. Este debe ser una cadena de dígitos.
     * @return JSON {@link CalificacionCarroDetailDTO} - La calificacion de
     * carro buscada
    ...
    /**
     * <h1>PUT /api/calificacionesCarro/{id} : Actualizar una calificacionde
     * carro con el id dado.</h1>
     ...
     * </pre>
     *
     * @param calificacion {@link CalificacionCarroDetailDTO} La calificacionde
     * carro que se desea guardar.
     * @return JSON {@link CalificacionCarroDTO} - La calificacion de carro
     * guardada.
     * @throws
     * co.edu.uniandes.csw.ivanysusbambam.exceptions.BusinessLogicException
     * @throws WebApplicationException {@link WebApplicationExceptionMapper} -
     * Error de lógica que se genera cuando no se encuentra una calificacionde
     * carro a actualizar.
     */
    @PUT
    ...
    /**
     * DELETE /api/calificacionCarro/{id} : Borrar una calificacion de carro por
     * id
     * <pre>
     * Codigos de respuesta:
     * <code style="color: mediumseagreen; background-color: #eaffe0;">
     ...
     * @throws BusinessLogicException si no existe la calificacion con el id
     * dado.
     */
    @DELETE
    @Path("{id: \\d+}")
